module.exports = {
  ...
  ETHEREUM_SEPOLIA: {
    ...
    subscriptionId: process.env.PUBLIC_ETHEREUM_SEPOLIA_CHAINLINK_SUBSCRIPTION_ID
  },
  ...
  POLYGON_AMOY: {
    ...
    subscriptionId: process.env.PUBLIC_POLYGON_AMOY_CHAINLINK_SUBSCRIPTION_ID
  },
  ...
  BSC_TESTNET: {
    ...
    subscriptionId: process.env.PUBLIC_BSC_TESTNET_CHAINLINK_SUBSCRIPTION_ID
  },
  ...
  ETHEREUM_MAINNET: {
    ...
    subscriptionId: process.env.PUBLIC_ETHEREUM_MAINNET_CHAINLINK_SUBSCRIPTION_ID
  },
  ...
  POLYGON_MAINNET: {
    ...
    subscriptionId: process.env.PUBLIC_POLYGON_MAINNET_CHAINLINK_SUBSCRIPTION_ID
  },
  ...
  BSC_MAINNET: {
    ...
    subscriptionId: process.env.PUBLIC_BSC_MAINNET_CHAINLINK_SUBSCRIPTION_ID
  }
};
